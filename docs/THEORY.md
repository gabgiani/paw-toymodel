...
|-------|------|--------------|
| 1. Unified Formula | Structural | Three pillars from one ρ\_S(k), validated across Versions A/B/C |
| 2. Informational arrow | Conceptual + numerical | Arrow present with T-symmetric Ĥ; disappears when access is unlimited |
| 3. Covariance Theorem | Algebraic proof + numerical | 720/720 permutations exact (error = 0) |
| 4. Continuity | Numerical | A(θ): +1 → 0 → −1 continuously; θ\* ≈ 0.365π |
| 5. Necessity | Contrapositiva | 5/5 conditions individually necessary |
| 6. Hardware | Experimental | IBM ibm\_torino: S\_eff = 0.583 ± 0.005 |
