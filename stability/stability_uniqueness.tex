...
\author{Gabriel Giani\\[4pt]
\small Working document --- Development notes}
...
in which the partial trace $\Tr_E$ is performed.
...
In this document we give a mathematical answer, working entirely within
...
of rank~$m$. By the Davis--Kahan $\sin\Theta$ theorem:
\begin{equation}
  \|Q-P_{\calA_0}\|_{2\to 2}
...
with $d=d_Sd_E$. By the Skolem--Noether theorem (for central simple algebras
...
\item \textbf{Block structure (superselection):} if $H$ decomposes as
  ...
  (``virtual subsystems'' in the sense of Zanardi--Knill).
...
\item Connection to decoherence theory and einselection (Zurek):
